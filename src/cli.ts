...
import { registerCcAiCommands } from "#/cli/register-cc-ai";
import { registerCcSearchCommands } from "#/cli/register-cc-search";
...
registerCcAiCommands(commandContext);
registerCcSearchCommands(commandContext);
